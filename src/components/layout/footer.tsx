...
export function Footer({ locale, copy }: FooterProps) {
  return (
    <footer className="bg-leafy px-7 lg:px-28 py-10 lg:py-14">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 pb-8 border-b border-white/10">
